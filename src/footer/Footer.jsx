...
const Footer = () => {
  return (
    <div className="footer-div 2xl:mt-150 2xl:mb-100 flex justify-between">
      ...
      <div className="second-section 2xl:mt-55">
      ...
      <div className="third-section 2xl:mt-52">
        <h2 className="text-white 2xl:text-25">Company</h2>
        <ul className="list-disc list-inside">
          <li className="text-[#C1C1C1] 2xl:mt-25 2xl:mb-20 2xl:text-18">
            About Us
          </li>
          <li className="text-[#C1C1C1] 2xl:mb-20 2xl:text-18">All Matches</li>
          <li className="text-[#C1C1C1] 2xl:mb-20 2xl:text-18">Top Tipsters</li>
          <li className="text-[#C1C1C1] 2xl:text-18">Contact</li>
        </ul>
      </div>

      <div className="fourth-section 2xl:mt-55">
        <p className="text-white 2xl:text-23">Subscribe Newslatter</p>
        <div className="flex flex-col">
          <div className="2xl:mt-28">
            <Input placeholder="Enter Email" className="2xl:w-300 2xl:h-44" />
          </div>
