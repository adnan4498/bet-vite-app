        ...
        <div className="flex flex-col sm:flex-row sm:mt-0  ">
          <div className="z-10">
            ...
            <img
              ...
              className=" 2xl:mt-160 xl:mt-150 mt-30 xl:w-10/12 lg:w-9/12 lg:mt-70"
            />
            ...
            <img
              src={bestInvestment}
              className="2xl:w-1050 xl:w-850 sm:w-930 sm:mt-25 mt-9 lg:w-10/12"
            />

            <div className="flex sm:mt-25 mt-15">
              <Button className="2xl:w-160 2xl:text-2xl xl:text-lg xl:w-125 2xl:h-60 lg:h-45 lg:w-110  xl:h-46 sm:mr-20 sm:h-50 lg:text-20 sm:text-2xl text-xs w-100 mr-10 rounded-lg bg-loginBgColor login-button">
                {" "}
                Login{" "}
              </Button>
              <Button className="2xl:text-2xl xl:text-lg lg:w-250 lg:h-45 xl:h-46 2xl:w-450 2xl:h-60 lg:text-16 sm:mr-20 sm:h-50  text-xs rounded-lg bg-loginBgColor crypto-currency-button">
                {" "}
