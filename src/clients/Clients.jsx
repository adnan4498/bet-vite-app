  ...
  return (
    <>
      ...
      <div className="clients-div 2xl:mt-300 2xl:mb-150 2xl:flex lg:flex lg:justify-evenly lg:container lg:mx-auto lg:mt-130 mt-250  ">
        ...
        <div className="w-7/12 client-carousel-div">
          <Carousel
            responsive={responsives}
            arrows={false}
            showDots={true}
            infinite={true}
            className="2xl:w-1075"
          >
            <div
              className="bg-cardDarkBlue w-full 2xl:h-455 rounded-3xl z-10 lg:mb-70 "
            ...
            >
              ...
              <div className="2xl:ml-50 2xl:mt-8">
                <img
                  src={clientQoute}
                  className="2xl:w-30 w-18 2xl:ml-0 2xl:mb-0 mb-10 ml-7"
                />
                <p className="text-[#C1C1C1] 2xl:leading-35 leading-25 text-center 2xl:pt-20 2xl:text-16 2xl:pr-20 text-12">
            ...
            <div
              className="bg-cardDarkBlue w-full 2xl:h-455 rounded-3xl z-10 "
              style={{ border: "9px solid #342f62" }}
            >
              <div className="flex justify-between">
                <div className="flex 2xl:mt-0 ">
