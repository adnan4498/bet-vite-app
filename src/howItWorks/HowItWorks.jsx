    ...
    <div className="howItWorks-div 2xl:mt-150 relative 2xl:mb-0 2xl:h-670 2xl:pt-0 lg:mb-100 lg:pt-5 lg:mt-50">
      <div className="2xl:block lg:block hidden">
        <img
          src={halfCircle}
          alt=""
          className="absolute 2xl:w-210 lg:w-90 lg:-top-60 -top-200 z-10"
        />  
        <img
          src={circle}
      ...
      >
        ...
        <div className="images-div mt-20 2xl:flex lg:flex 2xl:justify-evenly lg:justify-center  relative w-10/12 mx-auto">
          <img
            src={line}
            alt=""
            className="2xl:block 2xl:absolute lg:absolute lg:block lg:-z-10 lg:bottom-110 hidden 2xl:left-0 2xl:-top-49"
          />
          <div className="2xl:mb-0 mb-30 2xl:mt-30 lg:mt-0 mt-30 2xl:block lg:flex lg:flex-col">
            <div className="2xl:flex 2xl:flex-col 2xl:w-150 mx-auto relative">
              <img
                className="2xl:w-200 z-50 lg:w-110 w-250 mx-auto"
                src={sports}
              />
              <img
                src={sportsBlueBg}
            ...
            <h2 className="text-center lg:text-15 text-white 2xl:text-30 lg custom-font-family 2xl:mt-17 mt-20 lg:mt-0 text-20">
              Choose Favoured Sports
            </h2>
            <p className="text-center lg:text-10 text-[#C1C1C1] 2xl:mt-15 2xl:text-13 text-12 2xl:pt-0 pt-5">
          ...
          <div className="2xl:block lg:flex lg:flex-col  hidden">
            <div className="flex flex-col 2xl:w-250 mx-auto relative">
              <img className="z-10 2xl:w-150 lg:w-110" src={quantity} />
              <img
                src={sportsBlueBg}
                className="absolute 2xl:left- 2xl:left-10 2xl:-top-5 2xl:w-170"
              />
            </div>
            <h2 className="text-center lg:text-15 text-white 2xl:text-30  custom-font-family 2xl:mt-40">
              Choose Favoured Sports
            </h2>
            <p className="text-center lg:text-11 text-[#C1C1C1] 2xl:mt-15 2xl:text-13 2xl:pt-0 pt-5">
              Lorem ipsum dolor sit amet, consectetur adipiscing <br></br> elit.
              Phasellus.
            </p>
          </div>
          <div className="2xl:block lg:flex lg:flex-col  hidden">
            <div className="flex flex-col 2xl:w-250 mx-auto relative">
              <img className="z-10 2xl:w-150 lg:w-110" src={dance} />
              <img
                src={sportsBlueBg}
