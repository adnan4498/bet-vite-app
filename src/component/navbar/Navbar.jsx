...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <img src={purpleCurve} className="absolute 2xl:-top-90 xl:w-400  lg:-top-110 lg:h-550 lg:w-310 2xl:w-520 2xl:h-610 "/>
      <img src={pinkDot} className="absolute 2xl:-top-30 lg:-top-20 lg:w-100 2xl:w-215 lg:z-10 2xl:z-30  z-30" />
      <img src={purpleSplash} className="absolute 2xl:-top-100 xl:w-220 lg:-top-50 lg:w-200 lg:z-0 2xl:w-320 2xl:left-0 " />
      <img src={daimond} class="absolute 2xl:bottom-510 2xl:left-70 xl:w-45 xl:bottom-290 lg:left-15 2xl:w-70 2xl:top-330 lg:bottom-220 lg:w-35" />
      <img src={purpleEclipse} className="absolute 2xl:left-620 2xl:top-130 lg:w-180 lg:left-350 xl:w-250 xl:left-450 lg:top-120 2xl:w-320" />

      <img src={purpleEclipseRight} className="absolute xl:w-660 2xl:right-0 2xl:top-0 2xl:w-1020 lg:w-530 lg:opacity-50 lg:top-50 lg:right-0" />
      ...
      <img src={homeCircle} className="absolute 2xl:-bottom-120 2xl:left-10 2xl:w-130 lg:w-60 lg:right-2  0 xl:left-0 lg:-bottom-180 xl:-bottom-30 xl:w-90" />
      <img src={homeCircle} className="absolute 2xl:-bottom-380 2xl:right-100 xl:right-60 xl:-bottom-190 xl:w-70  2xl:w-90 lg:w-70 lg:-bottom-20" />
      {/* <img src={homeCircle} className="absolute 2xl:-bottom-130 2xl:right-60 2xl:w-90 z-10" /> */}
      <img src={daimond2} className="absolute 2xl:-bottom-300 2xl:right-920 2xl:left-860 2xl:w-150 lg:w-70 lg:left-500 xl:w-90 xl:left-790 xl:-bottom-100 lg:-bottom-85"/>
      {/* <img src={daimondBrightness} className="absolute 2xl:bottom-10 2xl:right-920 2xl:left-920 2xl:w-150 transform rotate-17"/> */}
      <img src={daimond} class="absolute 2xl:-bottom-420 z-10 2xl:left-290 xl:-bottom-210 2xl:w-40 transform rotate-12 lg:-bottom-200 lg:w-25 lg:left-120" /> 
      </div>
