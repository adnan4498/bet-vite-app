...
const MatchesCard3 = () => {
  return (
    ...
    <div className="container-2">
      ...
      <div className="container-2">
        <div>
          <h2 className=" text-white custom-font-family 2xl:text-50 text-center 2xl:mb-40 ">
            {/* Dog Racing */}
          </h2>
        </div>
        <div className="text-white 2xl:mb-30">
      ...
      <div className="container-2">
        ...
        <div className="flex justify-center 2xl:mt-110">
          <Button className="login-button bg-loginBgColor 2xl:w-135 2xl:h-45 rounded-lg">Back</Button>
          </div>
      </div>
