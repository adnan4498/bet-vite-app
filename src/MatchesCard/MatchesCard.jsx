    ...
    <>
      <div>
        <img
          src={half}
          alt=""
          className="2xl:absolute 2xl:block hidden right-0 top-900"
        />
        <img
          src={Vector4}
          className="2xl:absolute 2xl:block hidden 2xl:right-0 "
        />
        <img
          src={Vector3}
          className="2xl:absolute 2xl:block hidden 2xl:-left-150 opacity-70 "
        />
      ...
      <div className="2xl:container 2xl:mx-auto mt-50">
