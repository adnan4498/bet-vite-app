      ...
      <div className="container mx-auto">
        <div className="betting-feature-div 2xl:mt-150 2xl:mb-150 2xl:flex container-2 ">
          <div className="flex flex-col">
            ...
            <Button className="login-button bg-loginBgColor 2xl:w-150 2xl:h-49 2xl:mt-50 2xl:ml-7 rounded-lg mt-20 ">
              Get Started
            </Button>
          </div>

          <div className="4-divs-container 2xl:mt-0 mt-50 2xl:mb-0 mb-15 ">
            ...
            <div className="4-divs 2xl:ml-60 2xl:mt-33 ">
              <div className="betting-first-box 2xl:w-330 2xl:h-290 bg-[#060041] rounded-xl">
                <div className="betting-first-image relative">
                  <img
                    src={bettingFirstImgBg}
                    className="absolute inset-0 object-cover 2xl:mt-30 2xl:ml-30"
                  />
                  <img
                    src={bettingFirstImg}
                    className="relative z-10 2xl:top-46 2xl:left-48"
                  />
                </div>

                <div className="betting-first-box-text 2xl:pt-88 2xl:pl-30">
                  <p className="text-white 2xl:text-22 custom-font-family-3">
                    Easy Bets
                  </p>
                  <p className="text-[#C1C1C1] 2xl:pt-12 custom-font-family-4">
                    Lorem ipsum dolor sit amet <br></br> consectetur.
                  </p>
                </div>
              </div>
            ...
            <div className="4-divs 2xl:ml-30 2xl:mt-80">
              <div className="betting-first-box 2xl:w-330 2xl:h-290 bg-[#060041] rounded-xl">
                ...
                <div className="betting-first-box-text 2xl:pt-88 2xl:pl-30">
                  ...
                  <p className="text-[#C1C1C1] 2xl:pt-12 ">
                    Lorem ipsum dolor sit amet <br></br> consectetur.
                  </p>
                </div>
              </div>
