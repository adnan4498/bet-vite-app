  ...
  return (
    <>
      <div className="container-2">
        <div className="text-white 2xl:text-60 custom-font-family">
          All Matches For Betting
        </div>

        <div className="text-[#d8d0d0] 2xl:text-16 2xl:mt-20 2xl:pr-18  2xl:mb-50 custom-font-family-2 flex justify-between ">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          Phaselluspharetra <br></br> mi ut leo pulvinar laoreet.
          <Button className="login-button bg-loginBgColor 2xl:h-47 rounded-xl ">
            See All Matches
          </Button>
        </div>
